...
import { deleteJabatan } from '../../Services/jabatan.service';
import Button from '../Elements/Button';
import FormUpdateJabatan from './FormUpdateJabatan';
...
const TableJabatan: React.FC<TableJabatanProps> = ({ data, head, itemsPerPage }) => {
...
function UpdateModalJabatan(props:any) {
  return (
    <Modal
      {...props}
      size="lg"
